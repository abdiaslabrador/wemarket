"""
Django settings for weMarket project.
...
SECRET_KEY = 'x+&q-y=!dpea-=u)khbkru$td6#0=wsc#mqos2@@1*f*-bszcl'
...
WSGI_APPLICATION = 'weMarket.wsgi.application'
